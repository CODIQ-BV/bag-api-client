...
class PandApi
{
     ...
     *
     * @param  \BAGClient\Model\Point $body Geometrisch punt waarop de panden bepaald moeten worden. (required)
     ...
     * @return \BAGClient\Model\PandIOHalCollection
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\PandIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\Model\PandIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\PandIOHalCollection',
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\PandIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    public function pandIdentificatieWithHttpInfo($identificatie, $geldig_op = null, $beschikbaar_op = null, $accept_crs = null)
    {
        $returnType = '\BAGClient\Model\PandIOHal';
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\Model\PandIOLvcHalCollection
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\PandIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function pandLvcIdentificatieWithHttpInfo($identificatie, $gehele_lvc = 'false', $accept_crs = null)
    {
        $returnType = '\BAGClient\Model\PandIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\PandIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
