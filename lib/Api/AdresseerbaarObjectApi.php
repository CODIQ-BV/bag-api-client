...
class AdresseerbaarObjectApi
{
    ...
    /**
     * Operation bevragenAdresseerbaarObject
     *
     * Bevragen van één adresseerbaar object met een adresseerbaar object identificatie.
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
    ...
    {
        list($response) = $this->bevragenAdresseerbaarObjectWithHttpInfo($adresseerbaar_object_identificatie, $geldig_op, $beschikbaar_op, $expand, $accept_crs);
        return $response;
    }

    /**
     * Operation bevragenAdresseerbaarObjectWithHttpInfo
     *
     * Bevragen van één adresseerbaar object met een adresseerbaar object identificatie.
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\AdresseerbaarObjectIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\Model\AdresseerbaarObjectIOHal';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\AdresseerbaarObjectIOHal',
    ...
    /**
     * Operation bevragenAdresseerbaarObjectAsync
     *
     * Bevragen van één adresseerbaar object met een adresseerbaar object identificatie.
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
     ...
     */
    public function bevragenAdresseerbaarObjectAsync($adresseerbaar_object_identificatie, $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {
        return $this->bevragenAdresseerbaarObjectAsyncWithHttpInfo($adresseerbaar_object_identificatie, $geldig_op, $beschikbaar_op, $expand, $accept_crs)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bevragenAdresseerbaarObjectAsyncWithHttpInfo
     *
     * Bevragen van één adresseerbaar object met een adresseerbaar object identificatie.
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
    ...
    /**
     * Create request for operation 'bevragenAdresseerbaarObject'
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
     * @param  \DateTime $geldig_op Filtert op objecten die geldig zijn op de opgegeven datum &#x27;YYYY-MM-DD&#x27; Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     * @param  \DateTime $beschikbaar_op Filtert op objecten die beschikbaar zijn gekomen op de opgegeven datum en tijd &#x60;YYYY-MM-DDThh:mm:ss.sss&#x27;. Hierin kunnen de seconden &#x27;:ss&#x27; en milliseconden &#x27;.sss&#x27; of alleen de milliseconden conform ISO 8601 specificatie worden weggelaten, in dat geval krijgen deze automatisch de waarde &#x27;:00&#x27; respectievelijk &#x27;.000&#x27;. Indien er voor de milliseconden &#x27;.sss&#x27; meer dan 3 cijfers worden opgegeven, bv. &#x27;.12345&#x27;, dan wordt dit afgekapt tot &#x27;.123&#x27;. Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     ...
     */
    protected function bevragenAdresseerbaarObjectRequest($adresseerbaar_object_identificatie, $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {
        // verify the required parameter 'adresseerbaar_object_identificatie' is set
        if ($adresseerbaar_object_identificatie === null || (is_array($adresseerbaar_object_identificatie) && count($adresseerbaar_object_identificatie) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $adresseerbaar_object_identificatie when calling bevragenAdresseerbaarObject'
            );
        }

        $resourcePath = '/adresseerbareobjecten/{adresseerbaarObjectIdentificatie}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($adresseerbaar_object_identificatie !== null) {
            $resourcePath = str_replace(
                ...
                ObjectSerializer::toPathValue($adresseerbaar_object_identificatie),
                $resourcePath
            );
        }
    ...
    /**
     * Operation bevragenAdresseerbaarObjectLvc
     *
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\Model\AdresseerbaarObjectLvcIOHalCollection
     */
    public function bevragenAdresseerbaarObjectLvc($adresseerbaar_object_identificatie, $gehele_lvc = 'false', $accept_crs = null)
    {
        list($response) = $this->bevragenAdresseerbaarObjectLvcWithHttpInfo($adresseerbaar_object_identificatie, $gehele_lvc, $accept_crs);
        return $response;
    }

    /**
     * Operation bevragenAdresseerbaarObjectLvcWithHttpInfo
     *
     * Bevragen van de levenscyclus van een adresseerbaar object met een adresseerbaar object identificatie.
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\AdresseerbaarObjectLvcIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\Model\AdresseerbaarObjectLvcIOHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\AdresseerbaarObjectLvcIOHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation bevragenAdresseerbaarObjectLvcAsync
     *
     * Bevragen van de levenscyclus van een adresseerbaar object met een adresseerbaar object identificatie.
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bevragenAdresseerbaarObjectLvcAsync($adresseerbaar_object_identificatie, $gehele_lvc = 'false', $accept_crs = null)
    {
        return $this->bevragenAdresseerbaarObjectLvcAsyncWithHttpInfo($adresseerbaar_object_identificatie, $gehele_lvc, $accept_crs)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation bevragenAdresseerbaarObjectLvcAsyncWithHttpInfo
     *
     * Bevragen van de levenscyclus van een adresseerbaar object met een adresseerbaar object identificatie.
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
    ...
    /**
     * Create request for operation 'bevragenAdresseerbaarObjectLvc'
     *
     * @param  string $adresseerbaar_object_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
     * @param  bool $gehele_lvc Filtert naast geldige voorkomens ook de voorkomens die uit de geldige levenscyclus van het object zijn verwijderd. Als deze parameter wordt weggelaten worden alleen geldige voorkomens geretourneerd (default is false). (optional, default to false)
     * @param  string $accept_crs Gewenste CRS van de co�rdinaten in de response. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bevragenAdresseerbaarObjectLvcRequest($adresseerbaar_object_identificatie, $gehele_lvc = 'false', $accept_crs = null)
    {
        // verify the required parameter 'adresseerbaar_object_identificatie' is set
        if ($adresseerbaar_object_identificatie === null || (is_array($adresseerbaar_object_identificatie) && count($adresseerbaar_object_identificatie) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $adresseerbaar_object_identificatie when calling bevragenAdresseerbaarObjectLvc'
            );
        }

        $resourcePath = '/adresseerbareobjecten/{adresseerbaarObjectIdentificatie}/lvc';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation zoekAdresseerbaarObject
     *
     * Bevragen van één of meer adresseerbare objecten op basis van een nummeraanduiding identificatie.
     *
     * @param  string $nummeraanduiding_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (optional)
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\Model\AdresseerbareObjectenIOHalCollection
     */
    ...
    {
        list($response) = $this->zoekAdresseerbaarObjectWithHttpInfo($nummeraanduiding_identificatie, $huidig, $geldig_op, $beschikbaar_op, $expand, $accept_crs);
        return $response;
    }

    /**
     * Operation zoekAdresseerbaarObjectWithHttpInfo
     *
     * Bevragen van één of meer adresseerbare objecten op basis van een nummeraanduiding identificatie.
     *
     * @param  string $nummeraanduiding_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (optional)
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\AdresseerbareObjectenIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\Model\AdresseerbareObjectenIOHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\AdresseerbareObjectenIOHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation zoekAdresseerbaarObjectAsync
     *
     * Bevragen van één of meer adresseerbare objecten op basis van een nummeraanduiding identificatie.
     *
     * @param  string $nummeraanduiding_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function zoekAdresseerbaarObjectAsync($nummeraanduiding_identificatie = null, $huidig = 'false', $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {
        return $this->zoekAdresseerbaarObjectAsyncWithHttpInfo($nummeraanduiding_identificatie, $huidig, $geldig_op, $beschikbaar_op, $expand, $accept_crs)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation zoekAdresseerbaarObjectAsyncWithHttpInfo
     *
     * Bevragen van één of meer adresseerbare objecten op basis van een nummeraanduiding identificatie.
     *
     * @param  string $nummeraanduiding_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (optional)
    ...
    /**
     * Create request for operation 'zoekAdresseerbaarObject'
     *
     * @param  string $nummeraanduiding_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (optional)
     * @param  bool $huidig Indicatie dat alleen actuele object voorkomens zonder eindstatus gewenst zijn. (optional, default to false)
     * @param  \DateTime $geldig_op Filtert op objecten die geldig zijn op de opgegeven datum &#x27;YYYY-MM-DD&#x27; Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function zoekAdresseerbaarObjectRequest($nummeraanduiding_identificatie = null, $huidig = 'false', $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {

        $resourcePath = '/adresseerbareobjecten';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
