...
class OpenbareRuimteApi
{
     ...
     *
     * @param  string $openbare_ruimte_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (required)
    ...
    {
        list($response) = $this->openbareruimteIdentificatieWithHttpInfo($openbare_ruimte_identificatie, $geldig_op, $beschikbaar_op, $expand);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OpenbareRuimteIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\OpenbareRuimteIOHal';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OpenbareRuimteIOHal',
     ...
     */
    public function openbareruimteIdentificatieAsync($openbare_ruimte_identificatie, $geldig_op = null, $beschikbaar_op = null, $expand = null)
    {
        return $this->openbareruimteIdentificatieAsyncWithHttpInfo($openbare_ruimte_identificatie, $geldig_op, $beschikbaar_op, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function openbareruimteIdentificatieRequest($openbare_ruimte_identificatie, $geldig_op = null, $beschikbaar_op = null, $expand = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\OpenbareRuimteIOLvcHalCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OpenbareRuimteIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function openbareruimteLvcIdentificatieWithHttpInfo($openbare_ruimte_identificatie, $gehele_lvc = 'false')
    {
        $returnType = '\Swagger\Client\Model\OpenbareRuimteIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OpenbareRuimteIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $woonplaats_naam Naam van een woonplaats object uit de BAG. (optional)
     * @param  string $openbare_ruimte_naam Naam van een openbare ruimte object uit de BAG. (optional)
     * @param  string $woonplaats_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (optional)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\OpenbareRuimteIOHalCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\OpenbareRuimteIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\OpenbareRuimteIOHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\OpenbareRuimteIOHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
