...
class AdresApi
{
     ...
     * @return \BAGClient\Model\AdresIOHalCollection
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\AdresIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\Model\AdresIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\AdresIOHalCollection',
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\Model\AdresIOHal
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\AdresIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    public function bevraagAdressenMetNumIdWithHttpInfo($nummeraanduiding_identificatie, $expand = null)
    {
        $returnType = '\BAGClient\Model\AdresIOHal';
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\Model\ZoekResultaatHalCollection
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\ZoekResultaatHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function zoekWithHttpInfo($zoek, $page = '1', $page_size = '20')
    {
        $returnType = '\BAGClient\Model\ZoekResultaatHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\ZoekResultaatHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
