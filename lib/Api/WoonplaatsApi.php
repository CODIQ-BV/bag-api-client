...
class WoonplaatsApi
{
     ...
     *
     * @param  \BAGClient\Model\Point $body Geometrisch punt waarop de woonplaatsen bepaald moeten worden. (required)
     ...
     * @return \BAGClient\Model\WoonplaatsIOHalCollection
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\WoonplaatsIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\Model\WoonplaatsIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\WoonplaatsIOHalCollection',
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\WoonplaatsIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\Model\WoonplaatsIOHal';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\WoonplaatsIOHal',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\Model\WoonplaatsIOLvcHalCollection
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\Model\WoonplaatsIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function woonplaatsLvcIdentificatieWithHttpInfo($identificatie, $gehele_lvc = 'false', $expand = null, $accept_crs = null)
    {
        $returnType = '\BAGClient\Model\WoonplaatsIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\Model\WoonplaatsIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
