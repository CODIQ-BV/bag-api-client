...
class WoonplaatsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Point $body Geometrisch punt waarop de woonplaatsen bepaald moeten worden. (required)
     ...
     * @return \Swagger\Client\Model\WoonplaatsIOHalCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\WoonplaatsIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\WoonplaatsIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\WoonplaatsIOHalCollection',
     ...
     *
     * @param  string $identificatie De identificatie van een BAG object. Deze is 4 cijfers lang bij een woonplaats. (required)
     * @param  \DateTime $geldig_op Filtert op objecten die geldig zijn op de opgegeven datum &#x27;YYYY-MM-DD&#x27; Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     * @param  \DateTime $beschikbaar_op Filtert op objecten die beschikbaar zijn op de opgegeven datum en tijd &#x60;YYYY-MM-DDThh:mm:ss.sss&#x27; Hierin kunnen de seconden &#x27;:ss&#x27; en milliseconden &#x27;.sss&#x27; of alleen de milliseconden conform ISO 8601 specificatie worden weggelaten, in dat geval krijgen deze automatisch de waarde &#x27;:00&#x27; respectievelijk &#x27;.000&#x27;. Indien er voor de milliseconden &#x27;.sss&#x27; meer dan 3 cijfers worden opgegeven, bv. &#x27;.12345&#x27;, dan wordt dit afgekapt tot &#x27;.123&#x27;. Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     * @param  string $expand Hier kan aangegeven worden welke gerelateerde resources meegeladen moeten worden. Resources en velden van resources die gewenst zijn kunnen in de expand parameter kommagescheiden worden opgegeven. Specifieke velden van resource kunnen worden opgegeven door het opgeven van de resource-naam gevolgd door de veldnaam, met daartussen een punt. (optional)
     * @param  string $accept_crs Gewenste CRS van de co�rdinaten in de response. (optional)
    ...
    {
        list($response) = $this->woonplaatsIdentificatieWithHttpInfo($identificatie, $geldig_op, $beschikbaar_op, $expand, $accept_crs);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\WoonplaatsIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\WoonplaatsIOHal';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\WoonplaatsIOHal',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function woonplaatsIdentificatieAsync($identificatie, $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {
        return $this->woonplaatsIdentificatieAsyncWithHttpInfo($identificatie, $geldig_op, $beschikbaar_op, $expand, $accept_crs)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function woonplaatsIdentificatieRequest($identificatie, $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\WoonplaatsIOLvcHalCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\WoonplaatsIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function woonplaatsLvcIdentificatieWithHttpInfo($identificatie, $gehele_lvc = 'false', $expand = null, $accept_crs = null)
    {
        $returnType = '\Swagger\Client\Model\WoonplaatsIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\WoonplaatsIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation woonplaatsNaam
     *
     * bevragen van één of meer woonplaatsen met een woonplaatsnaam.
     *
     * @param  string $naam Naam van een woonplaats object uit de BAG. (required)
     * @param  \DateTime $geldig_op Filtert op objecten die geldig zijn op de opgegeven datum &#x27;YYYY-MM-DD&#x27; Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     * @param  \DateTime $beschikbaar_op Filtert op objecten die beschikbaar zijn op de opgegeven datum en tijd &#x60;YYYY-MM-DDThh:mm:ss.sss&#x27; Hierin kunnen de seconden &#x27;:ss&#x27; en milliseconden &#x27;.sss&#x27; of alleen de milliseconden conform ISO 8601 specificatie worden weggelaten, in dat geval krijgen deze automatisch de waarde &#x27;:00&#x27; respectievelijk &#x27;.000&#x27;. Indien er voor de milliseconden &#x27;.sss&#x27; meer dan 3 cijfers worden opgegeven, bv. &#x27;.12345&#x27;, dan wordt dit afgekapt tot &#x27;.123&#x27;. Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     * @param  string $expand Hier kan aangegeven worden welke gerelateerde resources meegeladen moeten worden. Resources en velden van resources die gewenst zijn kunnen in de expand parameter kommagescheiden worden opgegeven. Specifieke velden van resource kunnen worden opgegeven door het opgeven van de resource-naam gevolgd door de veldnaam, met daartussen een punt. (optional)
     * @param  string $accept_crs Gewenste CRS van de co�rdinaten in de response. (optional)
    ...
    {
        list($response) = $this->woonplaatsNaamWithHttpInfo($naam, $geldig_op, $beschikbaar_op, $expand, $accept_crs);
        return $response;
    }

    /**
     * Operation woonplaatsNaamWithHttpInfo
     *
     * bevragen van één of meer woonplaatsen met een woonplaatsnaam.
     *
     * @param  string $naam Naam van een woonplaats object uit de BAG. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function woonplaatsNaamAsync($naam, $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {
        return $this->woonplaatsNaamAsyncWithHttpInfo($naam, $geldig_op, $beschikbaar_op, $expand, $accept_crs)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation woonplaatsNaamAsyncWithHttpInfo
     *
     * bevragen van één of meer woonplaatsen met een woonplaatsnaam.
     *
     * @param  string $naam Naam van een woonplaats object uit de BAG. (required)
    ...
    /**
     * Create request for operation 'woonplaatsNaam'
     *
     * @param  string $naam Naam van een woonplaats object uit de BAG. (required)
     * @param  \DateTime $geldig_op Filtert op objecten die geldig zijn op de opgegeven datum &#x27;YYYY-MM-DD&#x27; Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     * @param  \DateTime $beschikbaar_op Filtert op objecten die beschikbaar zijn op de opgegeven datum en tijd &#x60;YYYY-MM-DDThh:mm:ss.sss&#x27; Hierin kunnen de seconden &#x27;:ss&#x27; en milliseconden &#x27;.sss&#x27; of alleen de milliseconden conform ISO 8601 specificatie worden weggelaten, in dat geval krijgen deze automatisch de waarde &#x27;:00&#x27; respectievelijk &#x27;.000&#x27;. Indien er voor de milliseconden &#x27;.sss&#x27; meer dan 3 cijfers worden opgegeven, bv. &#x27;.12345&#x27;, dan wordt dit afgekapt tot &#x27;.123&#x27;. Deze parameters komen uit de API strategie, het hoofdstuk tijdreizen. (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function woonplaatsNaamRequest($naam, $geldig_op = null, $beschikbaar_op = null, $expand = null, $accept_crs = null)
    {
        // verify the required parameter 'naam' is set
        if ($naam === null || (is_array($naam) && count($naam) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $naam when calling woonplaatsNaam'
            );
        }
