...
class StandplaatsApi
{
     ...
     *
     * @param  \Swagger\Client\Model\Point $body Geometrisch punt waarop de standplaatsen bepaald moeten worden. (required)
     ...
     * @return \Swagger\Client\Model\StandplaatsIOHalCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\StandplaatsIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\StandplaatsIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\StandplaatsIOHalCollection',
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\StandplaatsIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\Swagger\Client\Model\StandplaatsIOHal';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\StandplaatsIOHal',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \Swagger\Client\Model\StandplaatsIOLvcHalCollection
     */
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Swagger\Client\Model\StandplaatsIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function standplaatsLvcIdentificatieWithHttpInfo($identificatie, $gehele_lvc = 'false', $accept_crs = null)
    {
        $returnType = '\Swagger\Client\Model\StandplaatsIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\StandplaatsIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
