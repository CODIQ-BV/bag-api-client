...
class PandApi
{
     ...
     *
     * @param  \BAG\BAG\Point $body Geometrisch punt waarop de panden bepaald moeten worden. (required)
     ...
     * @return \BAG\BAG\PandIOHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\PandIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAG\BAG\PandIOHalCollection';
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\PandIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    public function pandIdentificatieWithHttpInfo($identificatie, $geldig_op = null, $beschikbaar_op = null, $accept_crs = null)
    {
        $returnType = '\BAG\BAG\PandIOHal';
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAG\BAG\PandIOLvcHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\PandIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function pandLvcIdentificatieWithHttpInfo($identificatie, $gehele_lvc = 'false', $accept_crs = null)
    {
        $returnType = '\BAG\BAG\PandIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAG\BAG\PandIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
