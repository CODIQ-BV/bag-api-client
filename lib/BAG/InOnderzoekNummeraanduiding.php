...
/**
 * InOnderzoekNummeraanduiding Class Doc Comment
 *
 * @category Class
 * @package  BAGClient
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InOnderzoekNummeraanduiding
{
    /**
     * Possible values of this enum
     */
    const HUISNUMMER = 'huisnummer';
const HUISLETTER = 'huisletter';
const HUISNUMMERTOEVOEGING = 'huisnummertoevoeging';
const POSTCODE = 'postcode';
const TYPE_ADRESSEERBAAR_OBJECT = 'type adresseerbaar object';
const STATUS = 'status';
const LIGT_IN = 'ligt in';
const LIGT_AAN = 'ligt aan';
    /**
