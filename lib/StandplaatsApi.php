...
class StandplaatsApi
{
     ...
     *
     * @param  \BAG\BAG\Point $body Geometrisch punt waarop de standplaatsen bepaald moeten worden. (required)
     ...
     * @return \BAG\BAG\StandplaatsIOHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\StandplaatsIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAG\BAG\StandplaatsIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAG\BAG\StandplaatsIOHalCollection',
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAG\BAG\StandplaatsIOHal
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\StandplaatsIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAG\BAG\StandplaatsIOHal';
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAG\BAG\StandplaatsIOLvcHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\StandplaatsIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function standplaatsLvcIdentificatieWithHttpInfo($identificatie, $gehele_lvc = 'false', $accept_crs = null)
    {
        $returnType = '\BAG\BAG\StandplaatsIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAG\BAG\StandplaatsIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
