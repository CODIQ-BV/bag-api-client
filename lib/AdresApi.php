...
class AdresApi
{
     ...
     * @param  string $adresseerbaar_object_identificatie Identificatie van een adresseerbaar object (ligplaats, standplaats of verblijfsobject) uit de BAG. (optional)
     ...
     * @param  string $pand_identificatie Identificatie van een object uit de BAG. Deze is 4 lang bij een woonplaats en 16 lang bij de andere objecten. (optional)
     ...
     * @return \BAGClient\BAGClient\AdresIOHalCollection
     */
    ...
    {
        list($response) = $this->bevraagAdressenWithHttpInfo($zoekresultaat_identificatie, $postcode, $huisnummer, $huisnummertoevoeging, $huisletter, $exacte_match, $adresseerbaar_object_identificatie, $woonplaats_naam, $openbare_ruimte_naam, $pand_identificatie, $expand, $page, $page_size);
        return $response;
    }
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\BAGClient\AdresIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAGClient\BAGClient\AdresIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\BAGClient\AdresIOHalCollection',
    ...
    {
        return $this->bevraagAdressenAsyncWithHttpInfo($zoekresultaat_identificatie, $postcode, $huisnummer, $huisnummertoevoeging, $huisletter, $exacte_match, $adresseerbaar_object_identificatie, $woonplaats_naam, $openbare_ruimte_naam, $pand_identificatie, $expand, $page, $page_size)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\BAGClient\AdresIOHal
     */
    public function bevraagAdressenMetNumId($nummeraanduiding_identificatie, $expand = null)
    {
        list($response) = $this->bevraagAdressenMetNumIdWithHttpInfo($nummeraanduiding_identificatie, $expand);
        return $response;
    }
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\BAGClient\AdresIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    public function bevraagAdressenMetNumIdWithHttpInfo($nummeraanduiding_identificatie, $expand = null)
    {
        $returnType = '\BAGClient\BAGClient\AdresIOHal';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\BAGClient\AdresIOHal',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bevraagAdressenMetNumIdAsync($nummeraanduiding_identificatie, $expand = null)
    {
        return $this->bevraagAdressenMetNumIdAsyncWithHttpInfo($nummeraanduiding_identificatie, $expand)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bevraagAdressenMetNumIdRequest($nummeraanduiding_identificatie, $expand = null)
    {
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAGClient\BAGClient\ZoekResultaatHalCollection
     */
     ...
     * @throws \BAGClient\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAGClient\BAGClient\ZoekResultaatHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function zoekWithHttpInfo($zoek, $page = '1', $page_size = '20')
    {
        $returnType = '\BAGClient\BAGClient\ZoekResultaatHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAGClient\BAGClient\ZoekResultaatHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
