...
/**
 * WoonplaatsIOHalCollectionEmbedded Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class WoonplaatsIOHalCollectionEmbedded implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'WoonplaatsIOHalCollection__embedded';
    ...
    protected static $swaggerTypes = [
        'woonplaatsen' => '\Swagger\Client\Model\WoonplaatsIOHal[]'    ];
    ...
    {
        $this->container['woonplaatsen'] = isset($data['woonplaatsen']) ? $data['woonplaatsen'] : null;
    }
     ...
     */
    public function getWoonplaatsen()
    {
        return $this->container['woonplaatsen'];
    }

    /**
     * Sets woonplaatsen
     *
     * @param \Swagger\Client\Model\WoonplaatsIOHal[] $woonplaatsen woonplaatsen
     *
     * @return $this
     */
    public function setWoonplaatsen($woonplaatsen)
    {
        $this->container['woonplaatsen'] = $woonplaatsen;
