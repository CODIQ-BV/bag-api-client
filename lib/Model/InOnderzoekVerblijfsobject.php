...
/**
 * InOnderzoekVerblijfsobject Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InOnderzoekVerblijfsobject
{
    /**
     * Possible values of this enum
     */
    const GEOMETRIE = 'geometrie';
const GEBRUIKSDOEL = 'gebruiksdoel';
const OPPERVLAKTE = 'oppervlakte';
const STATUS = 'status';
const MAAKT_DEEL_UIT_VAN = 'maakt deel uit van';
