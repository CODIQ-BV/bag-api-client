...
class TypeOpenbareRuimte
{
    ...
    const WEG = 'Weg';
const WATER = 'Water';
const SPOORBAAN = 'Spoorbaan';
const TERREIN = 'Terrein';
const KUNSTWERK = 'Kunstwerk';
const LANDSCHAPPELIJK_GEBIED = 'Landschappelijk gebied';
const ADMINISTRATIEF_GEBIED = 'Administratief gebied';
    /**
