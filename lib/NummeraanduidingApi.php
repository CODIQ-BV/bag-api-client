...
class NummeraanduidingApi
{
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\NummeraanduidingIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAG\BAG\NummeraanduidingIOHal';
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAG\BAG\NummeraanduidingIOLvcHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\NummeraanduidingIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function nummeraanduidingLvcIdentificatieWithHttpInfo($nummeraanduiding_identificatie, $gehele_lvc = 'false')
    {
        $returnType = '\BAG\BAG\NummeraanduidingIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAG\BAG\NummeraanduidingIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAG\BAG\NummeraanduidingIOHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\NummeraanduidingIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAG\BAG\NummeraanduidingIOHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAG\BAG\NummeraanduidingIOHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
