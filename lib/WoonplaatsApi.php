...
class WoonplaatsApi
{
     ...
     *
     * @param  \BAG\BAG\Point $body Geometrisch punt waarop de woonplaatsen bepaald moeten worden. (required)
     ...
     * @return \BAG\BAG\WoonplaatsIOHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\WoonplaatsIOHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAG\BAG\WoonplaatsIOHalCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAG\BAG\WoonplaatsIOHalCollection',
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\WoonplaatsIOHal, HTTP status code, HTTP response headers (array of strings)
     */
    ...
    {
        $returnType = '\BAG\BAG\WoonplaatsIOHal';
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BAG\BAG\WoonplaatsIOLvcHalCollection
     */
     ...
     * @throws \BAG\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BAG\BAG\WoonplaatsIOLvcHalCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function woonplaatsLvcIdentificatieWithHttpInfo($identificatie, $gehele_lvc = 'false', $expand = null, $accept_crs = null)
    {
        $returnType = '\BAG\BAG\WoonplaatsIOLvcHalCollection';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BAG\BAG\WoonplaatsIOLvcHalCollection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
