...
# **pandGeometrie**
> \BAG\BAG\PandIOHalCollection pandGeometrie($body, $content_crs, $accept_crs, $geldig_op, $beschikbaar_op, $huidig)
...
$apiInstance = new BAG\BAG\PandApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \BAG\BAG\Point(); // \BAG\BAG\Point | Geometrisch punt waarop de panden bepaald moeten worden.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\BAG\BAG\Point**](../Model/Point.md)| Geometrisch punt waarop de panden bepaald moeten worden. |
...
[**\BAG\BAG\PandIOHalCollection**](../Model/PandIOHalCollection.md)
...
# **pandIdentificatie**
> \BAG\BAG\PandIOHal pandIdentificatie($identificatie, $geldig_op, $beschikbaar_op, $accept_crs)
...
[**\BAG\BAG\PandIOHal**](../Model/PandIOHal.md)
...
# **pandIdentificatieVoorkomen**
> \BAG\BAG\PandIOHal pandIdentificatieVoorkomen($identificatie, $versie, $timestamp_registratie_lv, $accept_crs)
...
> \BAG\BAG\PandIOLvcHalCollection pandLvcIdentificatie($identificatie, $gehele_lvc, $accept_crs)
...
[**\BAG\BAG\PandIOLvcHalCollection**](../Model/PandIOLvcHalCollection.md)
