...
# **pandGeometrie**
> \Swagger\Client\Model\PandIOHalCollection pandGeometrie($body, $content_crs, $accept_crs, $geldig_op, $beschikbaar_op, $huidig)
...
$apiInstance = new Swagger\Client\Api\PandApi(
    // If you want use custom http client, pass your client which implements `GuzzleHttp\ClientInterface`.
    // This is optional, `GuzzleHttp\Client` will be used as default.
    new GuzzleHttp\Client(),
    $config
);
$body = new \Swagger\Client\Model\Point(); // \Swagger\Client\Model\Point | Geometrisch punt waarop de panden bepaald moeten worden.
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\Point**](../Model/Point.md)| Geometrisch punt waarop de panden bepaald moeten worden. |
...
[**\Swagger\Client\Model\PandIOHalCollection**](../Model/PandIOHalCollection.md)
...
# **pandIdentificatie**
> \Swagger\Client\Model\PandIOHal pandIdentificatie($identificatie, $geldig_op, $beschikbaar_op, $accept_crs)
...
[**\Swagger\Client\Model\PandIOHal**](../Model/PandIOHal.md)
...
# **pandIdentificatieVoorkomen**
> \Swagger\Client\Model\PandIOHal pandIdentificatieVoorkomen($identificatie, $versie, $timestamp_registratie_lv, $accept_crs)
...
> \Swagger\Client\Model\PandIOLvcHalCollection pandLvcIdentificatie($identificatie, $gehele_lvc, $accept_crs)
...
[**\Swagger\Client\Model\PandIOLvcHalCollection**](../Model/PandIOLvcHalCollection.md)
