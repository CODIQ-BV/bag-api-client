# BAG\Client\AlgemeneInformatieApi
...
# **getInfo**
> \BAG\Client\Model\APIInfo getInfo()
...
$apiInstance = new BAG\Client\Api\AlgemeneInformatieApi(
...
[**\BAG\Client\Model\APIInfo**](../Model/APIInfo.md)
