# BAG\Client\AdresseerbaarObjectApi
...
> \BAG\Client\Model\AdresseerbaarObjectIOHal bevragenAdresseerbaarObject($adresseerbaar_object_identificatie, $geldig_op, $beschikbaar_op, $expand, $accept_crs)
...
$apiInstance = new BAG\Client\Api\AdresseerbaarObjectApi(
...
[**\BAG\Client\Model\AdresseerbaarObjectIOHal**](../Model/AdresseerbaarObjectIOHal.md)
...
> \BAG\Client\Model\AdresseerbaarObjectLvcIOHalCollection bevragenAdresseerbaarObjectLvc($adresseerbaar_object_identificatie, $gehele_lvc, $accept_crs)
...
[**\BAG\Client\Model\AdresseerbaarObjectLvcIOHalCollection**](../Model/AdresseerbaarObjectLvcIOHalCollection.md)
...
> \BAG\Client\Model\AdresseerbareObjectenIOHalCollection zoekAdresseerbaarObject($nummeraanduiding_identificatie, $huidig, $geldig_op, $beschikbaar_op, $expand, $accept_crs)
...
[**\BAG\Client\Model\AdresseerbareObjectenIOHalCollection**](../Model/AdresseerbareObjectenIOHalCollection.md)
