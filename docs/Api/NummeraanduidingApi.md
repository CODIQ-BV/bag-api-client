...
> \BAG\BAG\NummeraanduidingIOHal nummeraanduidingIdentificatie($nummeraanduiding_identificatie, $geldig_op, $beschikbaar_op, $expand)
...
$apiInstance = new BAG\BAG\NummeraanduidingApi(
...
[**\BAG\BAG\NummeraanduidingIOHal**](../Model/NummeraanduidingIOHal.md)
...
# **nummeraanduidingIdentificatieVoorkomen**
> \BAG\BAG\NummeraanduidingIOHal nummeraanduidingIdentificatieVoorkomen($nummeraanduiding_identificatie, $versie, $timestamp_registratie_lv)
...
> \BAG\BAG\NummeraanduidingIOLvcHalCollection nummeraanduidingLvcIdentificatie($nummeraanduiding_identificatie, $gehele_lvc)
...
[**\BAG\BAG\NummeraanduidingIOLvcHalCollection**](../Model/NummeraanduidingIOLvcHalCollection.md)
...
> \BAG\BAG\NummeraanduidingIOHalCollection zoekNummeraanduiding($postcode, $huisnummer, $huisnummertoevoeging, $huisletter, $exacte_match, $woonplaats_naam, $openbare_ruimte_naam, $openbare_ruimte_identificatie, $huidig, $geldig_op, $beschikbaar_op, $page, $page_size, $expand)
...
[**\BAG\BAG\NummeraanduidingIOHalCollection**](../Model/NummeraanduidingIOHalCollection.md)
