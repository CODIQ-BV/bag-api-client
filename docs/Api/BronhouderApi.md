...
# **bevragenBronhouder**
> \BAG\BAG\BronhouderHal bevragenBronhouder($identificatie, $geldig_op, $beschikbaar_op)
...
$apiInstance = new BAG\BAG\BronhouderApi(
...
[**\BAG\BAG\BronhouderHal**](../Model/BronhouderHal.md)
...
> \BAG\BAG\BronhouderHal bronhouderIdentificatieVoorkomen($identificatie, $versie, $timestamp_registratie_lv)
...
# **zoekBronhouder**
> \BAG\BAG\BronhouderHalCollection zoekBronhouder($woonplaats_identificatie, $object_identificatie, $geldig_op, $beschikbaar_op)
...
[**\BAG\BAG\BronhouderHalCollection**](../Model/BronhouderHalCollection.md)
