...
------------ | ------------- | ------------- | -------------
**kenmerk** | [**\BAG\Client\Model\InOnderzoekWoonplaats**](InOnderzoekWoonplaats.md) |  | 
**identificatie_van_woonplaats** | [**\BAG\Client\Model\WoonplaatsIdentificatie**](WoonplaatsIdentificatie.md) |  | 
