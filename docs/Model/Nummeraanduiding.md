...
------------ | ------------- | ------------- | -------------
**identificatie** | [**\BAGClient\BAG\NummeraanduidingIdentificatie**](NummeraanduidingIdentificatie.md) |  | 
...
**type_adresseerbaar_object** | [**\BAGClient\BAG\TypeAdresseerbaarObject**](TypeAdresseerbaarObject.md) |  | 
...
**ligt_in** | [**\BAGClient\BAG\WoonplaatsIdentificatie**](WoonplaatsIdentificatie.md) |  | [optional] 
**ligt_aan** | [**\BAGClient\BAG\OpenbareRuimteIdentificatie**](OpenbareRuimteIdentificatie.md) |  | 
