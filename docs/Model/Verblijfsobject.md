...
------------ | ------------- | ------------- | -------------
**identificatie** | [**\Swagger\Client\Model\VerblijfsobjectIdentificatie**](VerblijfsobjectIdentificatie.md) |  | 
**domein** | **string** | NL.IMBAG.Verblijfsobject | 
**geometrie** | [**\Swagger\Client\Model\PuntOfVlak**](PuntOfVlak.md) |  | 
**gebruiksdoelen** | [**\Swagger\Client\Model\Gebruiksdoel[]**](Gebruiksdoel.md) |  | 
**oppervlakte** | **int** |  | 
**status** | [**\Swagger\Client\Model\StatusVerblijfsobject**](StatusVerblijfsobject.md) |  | 
...
**maakt_deel_uit_van** | [**\Swagger\Client\Model\PandIdentificatie[]**](PandIdentificatie.md) |  | 
